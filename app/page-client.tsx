  ...
  return (
    <DocumentsProvider>
      <EditorSettingsProvider>
        <LeftSidebarProvider defaultOpen={defaultLeftOpen} style={leftSidebarStyle}>
                  ...
                  <RightSidebarInset className="flex flex-1 flex-col overflow-hidden">
                    <header className="sticky top-0 z-10 border-b border-neutral-200 bg-neutral-50/80 backdrop-blur">
                      <div className="flex h-14 w-full items-center gap-3 px-4">
                        <LeftSidebarTrigger className="size-8" aria-label="切换文档侧栏" />
                        <div className="text-[15px] font-semibold tracking-tight">
                          AI Writer 工作台
                        </div>
                        <div className="ml-auto flex items-center gap-2">
                          <RightSidebarTrigger className="size-8" aria-label="切换 AI 侧栏" />
                        </div>
                      </div>
                    </header>
