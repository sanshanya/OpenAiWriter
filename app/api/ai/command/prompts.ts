  ...
  return buildStructuredPrompt({
    ...
    task: dedent`
      ...
      - For each comment, generate a JSON object:
        ...
        - comment: a brief comment or explanation for that fragment.
    `,
  });
}
